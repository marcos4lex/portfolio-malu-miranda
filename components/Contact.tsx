          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="w-full md:w-1/3 text-gray-600">
              ...
              <p className="mb-8 font-medium">
                Mamãe e papai cuidam de tudo! Mande uma mensagem pra gente.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <a href="#" className="w-12 h-12 bg-pinky-100 rounded-full flex items-center justify-center text-pinky-500 hover:bg-pinky-500 hover:text-white transition-all hover:scale-110">
                    <Instagram />
                  </a>
                  <a href="#" className="w-12 h-12 bg-pinky-100 rounded-full flex items-center justify-center text-pinky-500 hover:bg-pinky-500 hover:text-white transition-all hover:scale-110">
                    <Youtube />
