...
export const Hero: React.FC = () => {
  return (
    <section id="home" className="relative h-screen w-full overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 mt-32 md:mt-10 translate-y-[58px] md:translate-y-0 lg:translate-y-[160px]">
      ...
      <div className="absolute bottom-0 left-0 w-full leading-none text-pinky-50 lg:origin-bottom lg:scale-y-[0.45]">
