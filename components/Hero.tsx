...
export const Hero: React.FC = () => {
  return (
    <section id="home" className="relative h-screen w-full overflow-hidden bg-pinky-50">
      {/* Background Image */}
      <div
      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6 mt-32 md:mt-10 translate-y-[58px] md:translate-y-0 lg:translate-y-[55px] lg:[@media(min-height:800px)]:translate-y-[160px]">
        <div className="bg-white/20 backdrop-blur-sm p-2 rounded-full px-6 mb-6 border border-white/30 animate-fade-in-up lg:translate-y-[13px]">
        ...
        <div className="mt-8 flex gap-4 lg:-translate-y-[14px]">
      ...
      <div className="absolute bottom-0 left-0 w-full leading-none text-pinky-50 z-10 lg:origin-bottom lg:scale-y-[0.45]">
